...
abstract class AbstractStream
{
    ...
    public function readLine(): string
    {
        ...
        if ($lastError === null) {
            throw new TransportException(sprintf('Unable to read from connection to "%s" and error_get_last() returned null', $this->getReadConnectionDescription()));
        } else {
            throw new TransportException(sprintf('Unable to read from connection to "%s": %s', $this->getReadConnectionDescription(), $lastError['message']));
        }
        }

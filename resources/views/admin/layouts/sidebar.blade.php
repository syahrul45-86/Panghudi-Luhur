    ...
    <div class="container-fluid">
        ...
        <div class="navbar-nav flex-row d-lg-none">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                    ...
                    <span class="avatar avatar-sm" style="background-image: url({{ auth('admin')->user()->image }})"></span>
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item {{ sidebarItemActive(['admin.pengumuman.index*']) }}">
                ...
                <li class="nav-item {{ sidebarItemActive(['admin.spin.index*']) }}">
                    <a class="nav-link" href="{{ route('admin.spin.index') }}">
                ...
                <li class="nav-item {{ sidebarItemActive(['admin.users.index']) }}">
                ...
                <li class="nav-item dropdown {{ sidebarItemActive(['admin.hero.*', 'admin.feature.*', 'admin.counter-section.*', 'admin.about-section.*','admin.testimonial-section.*', 'admin.video-section.*','admin.featured-instructor-section.*', 'admin.brand-section.*', 'admin.latest-courses-section.*', 'admin.become-instructor-section.*']) }}">
                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-menu-columns">
                            ...
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item {{ sidebarItemActive(['admin.card-section.*']) }}" href="{{ route('admin.card-section.index') }}">
                                    Card Anggota
                                </a>
                            </div>

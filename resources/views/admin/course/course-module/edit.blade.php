...
<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
    <div class="add_course_basic_info">
        <form action="{{ route('admin.courses.update') }}" method="post" class="basic_info_update_form course-form" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-xl-6">
                ...
                <div class="add_course_basic_info_imput">
                    <label for="#">Demo Video Storages <b>(optional)</b></label>
            ...
            <div class="col-xl-6">
                ...
                <div class="col-xl-6">
                    <div class="add_course_basic_info_imput">
                        ...
                        <input type="text" placeholder="Price" name="price" value="{{ $course->slug }}">

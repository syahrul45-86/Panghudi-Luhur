   ...
   <nav class="navbar navbar-expand-lg main_menu main_menu_3">
       ...
       <div class="collapse navbar-collapse" id="navbarSupportedContent">
           <div class="menu_category">
               ...
               <ul>
                   @foreach ($categories as $category)
                       <li>
                           <a href="{{ route('kegiatan.index', ['main_category' => $category->slug]) }}">
                               <span>
                           ...
                           @if ($category->subCategories->count() > 0)
                               <ul class="category_sub_menu">
                                   @foreach ($category->subCategories as $subCategory)
                                       <li><a
                                               href="{{ route('kegiatan.index', ['category' => $subCategory->id]) }}">{{ $subCategory->name }}</a>
                                       </li>
                                   @endforeach
           ...
           <ul class="navbar-nav m-auto">
               ...
               <li class="nav-item">
                   <a class="nav-link" href="{{ route('kegiatan.index') }}">Kegiatan RT</a>
               </li>
               <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('cardanggota.index') }}">Cards</a>
            </li>
               <li class="nav-item">
   ...
   <div class="mobile_menu_area">
       ...
       <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions">
           ...
           <div class="offcanvas-body">
               ...
               <form class="mobile_menu_search" action="{{ route('kegiatan.index') }}">
                           ...
                           <ul class="main_mobile_menu">
                            @foreach ($categories as $category)
                               <li class="mobile_dropdown">
                                   ...
                                   <ul class="inner_menu">
                                       @foreach ($category->subCategories as $subCategory)
                                       <li><a href="{{ route('kegiatan.index', ['category' => $subCategory->id]) }}">{{ $subCategory->name }}</a></li>
                                       @endforeach
